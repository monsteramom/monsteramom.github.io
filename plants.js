...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function toggleCareDetails(plantName) {
        const details = document.getElementById(plantName + '-details');
        const icon = document.querySelector(`#${plantName}-toggle .toggle-icon`);
        const card = document.querySelector(`[data-plant="${plantName}"]`);
